...
const createShortDescription = (product, language) => {
 ...
 const ProductsPag = () => {
  ...
  return (
    <div className="pt-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 font-sans relative overflow-hidden">
      ...
      <section className="relative z-10 py-12 md:py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tight bg-gradient-to-r from-white via-blue-100 to-gray-100 bg-clip-text text-transparent">
          ...
          {filteredProducts.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
              {filteredProducts.map((product, index) => {
                ...
                return (
                  <div key={product.id} className="group relative bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl md:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 md:hover:-translate-y-2 overflow-hidden border-2 border-white/20 hover:border-yellow-400/50">
                    ...
                    <div className="relative h-56 sm:h-64 md:h-72 lg:h-56 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 overflow-hidden flex items-center justify-center">
                      ...
                      {cartItem && cartItem.quantity > 0 && (
                        <div className="absolute bottom-2 right-2 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-full animate-bounce z-20">
                          {cartItem.quantity} {language === 'en' ? 'in cart' : 'cart-ni'}
                        </div>
                      )}
                    ...
                    <div className="p-4 md:p-6">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-xl md:text-2xl font-black bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">
          ...
          {filteredProducts.length > 0 && (
            <div className="mt-12 md:mt-20 text-center bg-white/10 backdrop-blur-sm rounded-2xl md:rounded-3xl p-8 md:p-12 text-white relative overflow-hidden shadow-lg border-2 border-white/20">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-black mb-3 md:mb-4 bg-gradient-to-r from-white via-blue-100 to-gray-100 bg-clip-text text-transparent">
                ...
                >
                  ...
                  {language === 'en' ? 'View Cart' : 'Tazama Cart'}
